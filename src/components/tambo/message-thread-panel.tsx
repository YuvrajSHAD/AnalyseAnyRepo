  ...
  const defaultSuggestions: Suggestion[] = [
    {
      ...
      detailedSuggestion: "Show me the README summary",
      messageId: "readme-query",
    },
    {
      id: "suggestion-2",
      title: "Repo Structure",
      detailedSuggestion: "Show repository structure",
      messageId: "structure-query",
    },
    {
      id: "suggestion-3",
      title: "Open PRs",
      detailedSuggestion: "Show open pull requests",
      messageId: "prs-query",
    },
  ];
