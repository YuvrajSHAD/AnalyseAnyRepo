...
>(({ className, ...props }, ref) => {
  ...
  const handleViewComponent = (messageId: string | undefined, component: React.ReactNode) => {
    if (!messageId || !component) return;
    
    // Dispatch event to CanvasSpace to show this component
  ...
  return (
    ...
    >
      {filteredMessages.map((message, index) => {
        const hasComponent = message.role === "assistant" && message.renderedComponent;
          ...
          >
            ...
            >
              ...
              >
                ...
                {/* View Component Button - appears after assistant responses with components */}
                {hasComponent && (
                  <div className="flex justify-start">
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => handleViewComponent(message.id, message.renderedComponent)}
