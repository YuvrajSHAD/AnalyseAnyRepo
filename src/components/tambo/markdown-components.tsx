...
> => ({
  ...
  /**
   * Image component for rendering images in markdown
   * Handles both inline and block images with proper sizing
   * FIXED: Images now render properly in markdown files and PR descriptions
   */
  img: ({ src, alt, title }) => (
    <img
      src={src}
